...
function options = DNF1_stimulusGenerator(options)
...
switch options.taskVar.ruleCue.randomizerMode
    ...
    case 1
        ...
        tmpIndex = my_randsample(1:length(options.taskVar.ruleCue.position),1,true,options.taskVar.ruleCue.probabilities);
